...
public class FireworksManager : MonoBehaviour {
    ...
    public async Task SaveNewFireworkPart(CardInfo c) {
        ...
        Dictionary<string, object> fireworkProgressUpdates = new Dictionary<string, object>();
        fireworkProgressUpdates[fireworkProgressPath] = number;

        //await FirebaseData.Instance.reference.Child(fireworkProgressPath).SetValueAsync(number);
        await FirebaseData.Instance.reference.UpdateChildrenAsync(fireworkProgressUpdates);
    }
    ...
    [PunRPC]
    public async Task UpdateFireworksProgressUI(string color/*, int number*/) {
